...
| 系列                                                                           | 视角           | 目标读者                |
| ------------------------------------------------------------------------------ | -------------- | ----------------------- |
| [Hical 框架系列（01-05）]({{< relref "posts/hical/01-pmr-memory-pool-design.md" >}}) | 框架怎么设计   | 想理解 Hical 架构的人   |
...
| #   | 课程                                                                 | 核心主题                                         | 前置依赖 | 预计时长 |
| --- | -------------------------------------------------------------------- | ------------------------------------------------ | -------- | -------- |
| 1   | [Boost.System]({{< relref "posts/boost/Boost.System_错误处理基石.md" >}})  | 统一错误码、error_category、跨平台映射           | C++ 基础 | 1-2 小时 |
| 2   | [Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}})      | io_context、协程、TCP、定时器、多线程模型        | 课程 1   | 4-6 小时 |
| 3   | [Boost.Beast]({{< relref "posts/boost/Boost.Beast_HTTP与WebSocket.md" >}}) | HTTP 消息模型、Parser、WebSocket、SSL            | 课程 1+2 | 3-4 小时 |
| 4   | [Boost.JSON]({{< relref "posts/boost/Boost.JSON_序列化与反序列化.md" >}})  | 值类型体系、解析/序列化、PMR 集成、反射          | 课程 1   | 2-3 小时 |
| 5   | [Boost.MySQL]({{< relref "posts/boost/Boost.MySQL_异步数据库访问.md" >}})  | 协程式数据库访问、连接池、PreparedStatement 缓存 | 课程 1+2 | 3-5 小时 |
