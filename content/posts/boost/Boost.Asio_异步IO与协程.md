...
> **课程导航**：[学习路径]({{< relref "posts/boost/Boost库学习课程_学习路径导航.md" >}}) | [Boost.System]({{< relref "posts/boost/Boost.System_错误处理基石.md" >}}) | **Boost.Asio** | [Boost.Beast]({{< relref "posts/boost/Boost.Beast_HTTP与WebSocket.md" >}}) | [Boost.JSON]({{< relref "posts/boost/Boost.JSON_序列化与反序列化.md" >}}) | [Boost.MySQL]({{< relref "posts/boost/Boost.MySQL_异步数据库访问.md" >}})
...
Asio 提供了 TCP 层的异步 I/O。在 [课程 3: Boost.Beast]({{< relref "posts/boost/Boost.Beast_HTTP与WebSocket.md" >}}) 中，你将学习如何在 Asio 之上构建 HTTP/WebSocket 协议——Beast 用 Asio 的 socket 和 buffer，加上 HTTP 解析器，实现完整的 Web 协议栈。
