...
> **系列导航**：[入门篇]({{< relref "posts/boost/深入学习Boost.Asio_入门篇.md" >}}) | [进阶篇]({{< relref "posts/boost/深入学习Boost.Asio_进阶篇.md" >}}) | **实战篇**

## 前置知识

阅读本篇前，请确保已掌握：
- [入门篇]({{< relref "posts/boost/深入学习Boost.Asio_入门篇.md" >}})：io_context、异步操作生命周期、定时器
- [进阶篇]({{< relref "posts/boost/深入学习Boost.Asio_进阶篇.md" >}})：协程 Echo Server、多线程模型、strand
