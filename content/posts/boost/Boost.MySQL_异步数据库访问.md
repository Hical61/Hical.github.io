...
> **课程导航**：[学习路径]({{< relref "posts/boost/Boost库学习课程_学习路径导航.md" >}}) | [Boost.System]({{< relref "posts/boost/Boost.System_错误处理基石.md" >}}) | [Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}}) | [Boost.Beast]({{< relref "posts/boost/Boost.Beast_HTTP与WebSocket.md" >}}) | [Boost.JSON]({{< relref "posts/boost/Boost.JSON_序列化与反序列化.md" >}}) | **Boost.MySQL**

## 前置知识

- [课程 1: Boost.System]({{< relref "posts/boost/Boost.System_错误处理基石.md" >}})（`error_code`、`system_error`）
- [课程 2: Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}})（`io_context`、协程、`co_await` + `use_awaitable`）
