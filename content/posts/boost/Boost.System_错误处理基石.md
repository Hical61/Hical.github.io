...
> **课程导航**：[学习路径]({{< relref "posts/boost/Boost库学习课程_学习路径导航.md" >}}) | **Boost.System** | [Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}}) | [Boost.Beast]({{< relref "posts/boost/Boost.Beast_HTTP与WebSocket.md" >}}) | [Boost.JSON]({{< relref "posts/boost/Boost.JSON_序列化与反序列化.md" >}}) | [Boost.MySQL]({{< relref "posts/boost/Boost.MySQL_异步数据库访问.md" >}})
...
error_code 是 Asio 一切异步操作的基础返回值。在 [课程 2: Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}}) 中，你将看到 error_code 如何在 `async_read`、`async_write`、`async_accept` 等操作中被实际使用。
