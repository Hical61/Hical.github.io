...
> **课程导航**：[学习路径]({{< relref "posts/boost/Boost库学习课程_学习路径导航.md" >}}) | [Boost.System]({{< relref "posts/boost/Boost.System_错误处理基石.md" >}}) | [Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}}) | **Boost.Beast** | [Boost.JSON]({{< relref "posts/boost/Boost.JSON_序列化与反序列化.md" >}}) | [Boost.MySQL]({{< relref "posts/boost/Boost.MySQL_异步数据库访问.md" >}})

## 前置知识

- [课程 1: Boost.System]({{< relref "posts/boost/Boost.System_错误处理基石.md" >}})（`error_code`、`system_error`）
- [课程 2: Boost.Asio]({{< relref "posts/boost/Boost.Asio_异步IO与协程.md" >}})（`io_context`、协程、TCP socket）
...
Beast 负责传输 HTTP 消息，消息体中最常见的格式是 JSON。在 [课程 4: Boost.JSON]({{< relref "posts/boost/Boost.JSON_序列化与反序列化.md" >}}) 中，你将学习如何解析和生成 JSON 数据，以及 Hical 如何通过反射层实现自动序列化。
