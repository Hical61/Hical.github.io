...
- **Hical**: [GitHub](https://github.com/Hical61/Hical) | [快速上手]({{< relref "posts/hical/Hical-quick-rest-api.md" >}}) | [DB 中间件]({{< relref "posts/hical/hical-mysql-crud.md" >}}) | [日志系统]({{< relref "posts/hical/Hical日志系统完全指南.md" >}}) | [OpenAPI]({{< relref "posts/hical/hical-openapi-swagger.md" >}})
