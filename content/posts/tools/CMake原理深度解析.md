...
这就是为什么在 [现代 CMake 实践]({{< relref "posts/tools/现代cmake实践.md" >}}) 里提到要用 Generator Expressions 而不是 `if(CMAKE_BUILD_TYPE STREQUAL "Debug")`——多配置生成器下，`CMAKE_BUILD_TYPE` 在配置时是空的！
