...
> **系列导航**：**入门篇** | [进阶篇]({{< relref "posts/cpp/深入学习io_uring_进阶篇.md" >}}) | [实战篇]({{< relref "posts/cpp/深入学习io_uring_实战篇.md" >}})
...
下一篇 [进阶篇]({{< relref "posts/cpp/深入学习io_uring_进阶篇.md" >}}) 将深入高级特性（SQPOLL、Fixed Buffers、Linked SQE）和 TCP 网络编程。
