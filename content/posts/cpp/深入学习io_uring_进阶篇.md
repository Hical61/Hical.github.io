...
> **系列导航**：[入门篇]({{< relref "posts/cpp/深入学习io_uring_入门篇.md" >}}) | **进阶篇** | [实战篇]({{< relref "posts/cpp/深入学习io_uring_实战篇.md" >}})
...
下一篇 [实战篇]({{< relref "posts/cpp/深入学习io_uring_实战篇.md" >}}) 将用 C++ 封装 io_uring，实现协程集成和高性能服务器架构。
