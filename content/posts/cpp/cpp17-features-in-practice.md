...
一套代码，两种行为，编译期决定。相关的详细设计可以参考我的另一篇文章 [if constexpr 实现 TCP/SSL 零成本统一]({{< relref "posts/hical/04-if-constexpr-tcp-ssl-unification.md" >}})。
...
- **PMR**：强大但复杂，建议单独深入学习（参考我的 [PMR 专属文章]({{< relref "posts/cpp/深入学习CPP17_PMR.md" >}}))
