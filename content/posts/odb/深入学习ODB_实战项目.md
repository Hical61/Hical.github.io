...
> **系列导航**：[编译器与注解]({{< relref "posts/odb/深入学习ODB_编译器与注解.md" >}}) | [连接与事务]({{< relref "posts/odb/深入学习ODB_连接与事务.md" >}}) | [对象关系]({{< relref "posts/odb/深入学习ODB_对象关系.md" >}}) | [类型安全查询]({{< relref "posts/odb/深入学习ODB_类型安全查询.md" >}}) | [继承与视图]({{< relref "posts/odb/深入学习ODB_继承与视图.md" >}}) | [迁移与多库]({{< relref "posts/odb/深入学习ODB_迁移与多库.md" >}}) | [性能与实践]({{< relref "posts/odb/深入学习ODB_性能与实践.md" >}}) | **实战项目**（本文）
...
| 篇章                                                   | 核心收获                                   |
| ------------------------------------------------------ | ------------------------------------------ |
| [第一篇]({{< relref "posts/odb/深入学习ODB_编译器与注解.md" >}}) | 编译期代码生成、pragma 注解、第一个 Player |
| [第二篇]({{< relref "posts/odb/深入学习ODB_连接与事务.md" >}})   | 连接池、RAII 事务、CRUD、session 缓存      |
| [第三篇]({{< relref "posts/odb/深入学习ODB_对象关系.md" >}})     | 一对一/一对多/多对多、lazy_ptr、inverse    |
| [第四篇]({{< relref "posts/odb/深入学习ODB_类型安全查询.md" >}}) | 操作符重载查询、动态条件、预备语句         |
| [第五篇]({{< relref "posts/odb/深入学习ODB_继承与视图.md" >}})   | 三种继承策略、View 投影与聚合              |
| [第六篇]({{< relref "posts/odb/深入学习ODB_迁移与多库.md" >}})   | changelog 迁移、多数据库切换               |
| [第七篇]({{< relref "posts/odb/深入学习ODB_性能与实践.md" >}})   | 批量操作、N+1 规避、section、连接池调优    |
