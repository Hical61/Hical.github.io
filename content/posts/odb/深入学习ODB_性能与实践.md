...
> **系列导航**：[编译器与注解]({{< relref "posts/odb/深入学习ODB_编译器与注解.md" >}}) | [连接与事务]({{< relref "posts/odb/深入学习ODB_连接与事务.md" >}}) | [对象关系]({{< relref "posts/odb/深入学习ODB_对象关系.md" >}}) | [类型安全查询]({{< relref "posts/odb/深入学习ODB_类型安全查询.md" >}}) | [继承与视图]({{< relref "posts/odb/深入学习ODB_继承与视图.md" >}}) | [迁移与多库]({{< relref "posts/odb/深入学习ODB_迁移与多库.md" >}}) | **性能与实践**（本文） | [实战项目]({{< relref "posts/odb/深入学习ODB_实战项目.md" >}})
