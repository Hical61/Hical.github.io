...
> **系列导航**：[第一篇：设计理念]({{< relref "posts/hical/从零构建现代C++ Web服务器（一）.md" >}}) | [第二篇：协程与内存池]({{< relref "posts/hical/从零构建现代C++ Web服务器（二）.md" >}}) | [第三篇：路由、中间件与SSL]({{< relref "posts/hical/从零构建现代C++ Web服务器（三）.md" >}}) | [第四篇：实战与性能]({{< relref "posts/hical/从零构建现代C++ Web服务器（四）.md" >}}) | [第五篇：Cookie、Session与文件服务]({{< relref "posts/hical/从零构建现代C++ Web服务器（五）.md" >}}) | [第六篇：数据库中间件](#)（本文）
...
> **上一篇**：[从零构建现代C++ Web服务器（五）：Cookie、Session、静态文件与文件上传]({{< relref "posts/hical/从零构建现代C++ Web服务器（五）.md" >}})
