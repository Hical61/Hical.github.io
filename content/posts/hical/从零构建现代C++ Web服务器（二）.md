...
> **系列导航**：[第一篇：设计理念]({{< relref "posts/hical/从零构建现代C++ Web服务器（一）.md" >}}) | [第二篇：协程与内存池](#)（本文） | [第三篇：路由、中间件与SSL]({{< relref "posts/hical/从零构建现代C++ Web服务器（三）.md" >}}) | [第四篇：实战与性能]({{< relref "posts/hical/从零构建现代C++ Web服务器（四）.md" >}}) | [第五篇：Cookie、Session与文件服务]({{< relref "posts/hical/从零构建现代C++ Web服务器（五）.md" >}}) | [第六篇：数据库中间件]({{< relref "posts/hical/从零构建现代C++ Web服务器（六）.md" >}})
...
> **上一篇**：[从零构建现代C++ Web服务器（一）：设计理念与架构总览]({{< relref "posts/hical/从零构建现代C++ Web服务器（一）.md" >}})
>
> **下一篇**：[从零构建现代C++ Web服务器（三）：路由、中间件与 SSL]({{< relref "posts/hical/从零构建现代C++ Web服务器（三）.md" >}})
