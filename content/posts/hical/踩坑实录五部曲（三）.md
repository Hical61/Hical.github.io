...
自研日志的好处在[开发心得]({{< relref "posts/hical/Hical框架开发心得.md" >}})里聊过了。这篇只聊坑——从"能跑"到"能在生产环境跑"的过程中，踩过的 8 个真实问题。
...
> **上一篇**：[Hical 踩坑实录五部曲（二）：MSVC / GCC / Clang 三平台 C++20 编译差异]({{< relref "posts/hical/踩坑实录五部曲（二）.md" >}})
>
> **下一篇**：[Hical 踩坑实录五部曲（四）：PMR 三层内存池——从理论完美到实战翻车]({{< relref "posts/hical/踩坑实录五部曲（四）.md" >}})
