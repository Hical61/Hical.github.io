...
> Hical 是一个现代 C++ 高性能 Web 框架，基于 Boost.Asio/Beast，具备 [PMR 内存池]({{< relref "posts/hical/01-pmr-memory-pool-design.md" >}})、[协程异步 I/O]({{< relref "posts/hical/02-coroutine-driven-http-server.md" >}})、WebSocket、SSL/TLS、[C++26 反射层]({{< relref "posts/hical/03-cpp26-reflection-dual-track.md" >}})等特性。本文覆盖**游戏行业 + 通用行业**的全部适用场景。
...
| 内部微服务 HTTP 层 | [MetaJson/MetaRoutes]({{< relref "posts/hical/03-cpp26-reflection-dual-track.md" >}}) 零样板代码 |
...
**为什么适合**：
- 高并发：默认 10,000 连接，[EventLoopPool]({{< relref "posts/hical/04-if-constexpr-tcp-ssl-unification.md" >}}) 多线程
...
**为什么适合**：
- 现代 C++20/26 特性的学习范本（[协程]({{< relref "posts/hical/02-coroutine-driven-http-server.md" >}})、[Concepts]({{< relref "posts/hical/05-concepts-backend-abstraction.md" >}})、[PMR]({{< relref "posts/hical/01-pmr-memory-pool-design.md" >}})、[反射]({{< relref "posts/hical/03-cpp26-reflection-dual-track.md" >}})）
